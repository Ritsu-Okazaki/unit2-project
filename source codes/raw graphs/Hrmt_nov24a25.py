...
plt.ylabel("Humidity/%")
plt.title("Remote BME280 Humidity Measurements Nov 24th ~ Nov 25th")
...
plt.plot(pdates,sensor_11)

# Smoothed
plt.plot(pdates[:-40],moving_average(40, sensor_11),color='black',alpha = 0.7,label='smoothed by window 40')

# Mathematical model
y_octic = []
a,b,c,d,e,f,g,h,I = np.polyfit(timeindex, sensor_11, deg=8)
for i in timeindex:
