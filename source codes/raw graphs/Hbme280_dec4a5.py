...
plt.ylabel("Humidity/%")
plt.title("BME280 Humidity Measurements Dec 4rd ~ Dec 5th")
...
plt.plot(pdates,sensor_206)

# Smoothed
plt.plot(pdates[:-40],moving_average(40, sensor_206),color='black',alpha = 0.7,label='smoothed by window 40')
