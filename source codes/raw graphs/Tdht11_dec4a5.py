...
plt.title("DHT11 Temperature Measurements Dec 4rd ~ Dec 5th")
...
plt.plot(pdates,sensor_203)

# Smoothed
plt.plot(pdates[:-40],moving_average(40, sensor_203),color='black',alpha = 0.7,label='smoothed by window 40')

# Mathematical model
y_octic = []
a,b,c,d,e,f,g,h,I = np.polyfit(timeindex, sensor_203, deg=8)
for i in timeindex:
