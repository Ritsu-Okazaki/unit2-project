...
| 2       | Verify that the local humidity, temperature, and atmospheric pressure values  are measured using a set of sensors placed around the dormitory.                                                             | Check the evidence1.jpg and evidence2.jpg in github repository                                                                                                               | Photos of location and  a set of sensors                                                      |            |
